          ...
          <div class="max-w-xl mx-auto">
            <div class="text-center ">
              <div class="relative flex flex-col items-center">
                ...
                <h1 class="text-5xl font-bold dark:text-white"> Our <span class="text-blue-500"> Contact
                </span> </h1>
              ...
              <p class="mb-16 text-base text-center text-gray-500">
                You can reach out to us anytime you need!
              </p>
            </div>
          </div>
            ...
            <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
              <div
                ...
                <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                  Email</h2>
                <a href="#"
                  class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">teamsoftrackers@gmail.com</a>
              </div>
            </div>
            <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
              <div
                ...
                <h2 class="mb-4 text-xl font-bold leading-9 text-gray-700 md:text-2xl dark:text-gray-400">
                  Phone</h2>
                <a href="#"
                  class="text-base font-medium text-gray-500 md:text-lg dark:text-gray-400">+91 9552874929</a>
              </div>
            </div>
            <div class="w-full px-4 mb-4 lg:w-1/3 lg:mb-0">
              <div
