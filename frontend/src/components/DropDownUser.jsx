...
import UserOne  from '../assets/sih-logo.png'
    ...
    <div className="relative">
      ...
      >
        <span className="hidden text-right lg:block">
          ...
          <span className="block text-xs">ID: {user._id ? user._id.slice(0, 6) : ''}</span>
        </span>
        ...
        <ul className="flex flex-col gap-5 border-b border-stroke px-6 py-7.5 dark:border-strokedark">
          <li>
            <Link
              ...
              className="mb-3 flex items-center gap-3.5 mt-3 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            >
              <svg
